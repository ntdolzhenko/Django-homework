...
urlpatterns = [
    ...
    path('project/new/', views.create_project, name='add_new_project'),
    ...
    path('project/<int:project_id>/add_task/', views.TaskCreateView.as_view(), name='create_task_in_project'),
